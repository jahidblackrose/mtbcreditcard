/**
 * Final Review Step - Live photo capture before submission
 */
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="border-warning/50 bg-warning/5">
        <CardContent className="pt-6">
          <div className="flex gap-4">
            ...
            <div>
              <h4 className="font-semibold text-warning-foreground">Important</h4>
      ...
      <Card className={cn(
        ...
        termsAccepted && declarationAccepted && livePhoto 
