...
export const APPLICATION_STEPS: Omit<FormStep, 'isComplete'>[] = [
  ...
  { id: 'bank-accounts', stepNumber: 5, title: 'Existing Bank Accounts', description: 'This section is optional. Add any existing bank accounts you have.', isOptional: true },
  { id: 'credit-facilities', stepNumber: 6, title: 'Credit & Loans', description: 'Existing credit facilities', isOptional: true },
  { id: 'nominee', stepNumber: 7, title: 'Nominee Information', description: 'Nominee details for MTB Protection Plan', isOptional: false },
